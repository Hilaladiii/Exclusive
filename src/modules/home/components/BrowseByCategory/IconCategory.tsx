export function IconPhone() {
  return (
    ...
    >
      <g clip-path="url(#clip0_900_1693)">
        <path
...
export function IconCamera() {
  return (
    <svg
      ...
      className="group-hover:text-white"
    >
      <g clip-path="url(#clip0_909_1959)">
        <path
...
export function IconHeadPhone() {
  return (
    <svg
      ...
      className="group-hover:text-white"
    >
      <g clip-path="url(#clip0_909_1225)">
        <path
...
export function IconGaming() {
  return (
    <svg
      ...
      className="group-hover:text-white"
    >
      <g clip-path="url(#clip0_909_3077)">
        <path
...
export function IconSmartWatch() {
  return (
    <svg
      width="56"
      height="56"
      ...
      className="group-hover:text-white"
    >
      <g clip-path="url(#clip0_909_1297)">
        <path
